// ═══════════════════════════════════════════════════════════════════════════════════════════════════
// HomeStyle.tsx - Estilos da Página Home (Página Inicial)
// ═══════════════════════════════════════════════════════════════════════════════════════════════════
// Este arquivo contém todos os componentes estilizados para a página inicial da loja.
// Inclui hero rotativo, carrosséis de produtos, seções promocionais, boutique, booking e footer.
// ═══════════════════════════════════════════════════════════════════════════════════════════════════
import styled from "styled-components";
import { LabelCaps, PrimaryButton, EditorialDivider } from "../components/UI";

// ─── Seção Hero (Destaque Principal) ────────────────────────────────────────────────────────────────
// Seção de hero rotativo com imagem de fundo, overlay e conteúdo centralizado à esquerda.
// Componente principal da página inicial com altura de 100vh e transições de slide.
...
// ─── Header de Seção (Título + Link Ver Todos) ──────────────────────────────────────────────────────
// Container do cabeçalho de seções (usado em carrosséis e listas de produtos).
