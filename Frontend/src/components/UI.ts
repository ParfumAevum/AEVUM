...
// ─── Display Extra Large (Display XL) ────────────────────────────────────────────────────────────────
// Maior estilo de tipografia, usado para títulos de página e headlines principais.
...
// Estilo de headline grande para seções e subtítulos principais.
...
// Estilo de headline médio para títulos de subseções e cards.
...
// ─── Label em Maiúsculas (Label Caps) ────────────────────────────────────────────────────────────────
// Estilo para labels em formato maiúsculo, frequentemente usado em breadcrumbs e tags.
...
// ─── Divisor Editorial ───────────────────────────────────────────────────────────────────────────────
// Linha decorativa com cor primária (ouro), usada para separar seções importantes.
